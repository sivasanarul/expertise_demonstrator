...
def preprocessing(variables_filename = 'preprocessing_variables.pkl'):
    ...
    for domain_id,param_dict in mesh_dict.items():
        ...
        domain_tag = param_dict['domain_tag']
...
if __name__ == "__main__":
    ...
    save_solution_obj_file = 'simple_parametric_bladed_disk_v11.pkl'
    ...
    # running the main HBM simulation 
    variables_filename = 'preprocessing_variables.pkl'
    try:
        variables_dict = utils.load_object(variables_filename,tries=1,sleep_delay=1)
        if variables_dict is None:
            raise ValueError('None variable object was found.')
    except:
        variables_dict = preprocessing(variables_filename)
